	...
	<div class="page-title">
		<div class="page-title-center">
			...
			<p class="boxed-text center-text">
				Small screens deserve columns as well and sometimes they are quite essential.
			</p>
	...
	<div class="page-content">
		<div class="content full-top">
			<div>
				...
				<amp-img class="half-bottom" src="images/pictures/6w.jpg" layout="responsive" width="700" height="263"></amp-img>
				<p>
			...
			<div class="left-column">
				...
				<amp-img class="half-bottom" src="images/pictures/isolated/1.jpg" layout="responsive" width="533" height="533"></amp-img>
				<p>
					Praesent eget massa tristique, viverra nulla in, euismod lacus. Phasellus vitae urna quis arcu iaculis posuere
				</p>
			</div>
			<div class="right-column">
				...
				<amp-img class="half-bottom" src="images/pictures/isolated/5.jpg" layout="responsive" width="533" height="533"></amp-img>
				<p>
					Praesent eget massa tristique, viverra nulla in, euismod lacus. Phasellus vitae urna quis arcu iaculis posuere
				</p>
			</div>
		...
		<div class="content">
			<div class="one-third-left">
				...
				<amp-img class="half-bottom" src="images/pictures/isolated/6.jpg" layout="responsive" width="533" height="533"></amp-img>
				<p>Cras egestas mollis semper.</p>
			</div>
			<div class="one-third-center">
				<h4 class="quarter-bottom">2/3</h4>
				<amp-img class="half-bottom" src="images/pictures/isolated/4.jpg" layout="responsive" width="533" height="533"></amp-img>
				<p>Cras egestas mollis semper.</p>
			</div>
			<div class="one-third-right">
				<h4 class="quarter-bottom">3/3</h4>
				<amp-img class="half-bottom" src="images/pictures/isolated/9.jpg" layout="responsive" width="533" height="533"></amp-img>
				<p>Cras egestas mollis semper.</p>
			</div>
			<div class="clear"></div>
		</div>

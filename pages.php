...
<body>		
	...
	<div class="page-title page-title-transparent">
		<div class="page-title-center">
			...
			<p class="boxed-text center-text">
				Custom built Pages designed to spice up your AMP file and give it a bit more life.
			</p>
	...
	<div class="boxed-content">
		<div class="link-icons">
			<p>
				Remeber. Google AMP does not allow the use of any JS, so all pages have been built only pure CSS3.
			</p>
			<a href="page-splash.php"><i class="fa fa-star-o"></i>Splash</a>
			<a href="page-landing.php"><i class="fa fa-heart-o"></i>Landing</a>
			<a href="page-error.php"><i class="fa fa-warning"></i>404</a>
			<a href="page-soon.php"><i class="fa fa-clock-o"></i>Soon</a>
			<a href="page-profile.php"><i class="fa fa-user-o"></i>Profile</a>
			<a href="page-timeline.php"><i class="fa fa-navicon"></i>Timeline</a>
			<a href="page-portfolio.php"><i class="fa fa-picture-o"></i>Portfolio</a>
			<a href="page-portfolio-selected.php"><i class="fa fa-picture-o"></i>Selected Item</a>

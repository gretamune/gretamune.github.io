...
<body>		
	...
	<div class="page-content">
		...
		<div class="content full-top full-bottom">
			<h4>LightBox Without Caption</h4>
		</div>

		<amp-image-lightbox id="lightbox1"layout="nodisplay"></amp-image-lightbox>
		<amp-img class="full-bottom" on="tap:lightbox1" role="button" tabindex="0" layout="responsive" src="images/pictures/6.jpg" width="300" height="200"></amp-img>

		<div class="content full-top full-bottom">
			<h4>LightBox With Caption</h4>
		</div>

		<figure>
			<amp-img on="tap:lightbox1" role="button" tabindex="0" layout="responsive" src="images/pictures/1.jpg" width="300" height="200"></amp-img>

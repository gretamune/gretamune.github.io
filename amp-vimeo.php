...
<body>		
	...
	<div class="page-content">
		<div class="content full-top">
			<h4>Vimeo</h4>
			<p>
				Embed simple video elements from SoundCloud and enjoy them with great ease.
			</p>
		</div>

		<amp-vimeo data-videoid="23534361" layout="responsive" width="16" height="9"></amp-vimeo>	
	</div>
